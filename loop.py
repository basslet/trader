...
start_date_range = pd.date_range(start="2010-03-03", end="2021-03-03", freq="12ME")
...
for start_date in start_date_range:
    ...
    for low_sell_factor in [round(x, 2) for x in list(frange(0.95, 1.03, 0.01))]:
...
results_df.to_csv(os.path.join(output_dir, "_parameter_sweep_results.csv"), index=False)
